...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:37px;margin-left:35px;"><select id="calendar_hour" style="width:40px">';
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:57px; margin-left:27px"><select id="calendar_newMonth" style="width:60px">';
    ...
    init: function(e) {
        ...
        this.lastInput = null;
        this.disabledInputs = [];
        $('body').append('<div id="calendar_div" style="background:#fff"></div>');
