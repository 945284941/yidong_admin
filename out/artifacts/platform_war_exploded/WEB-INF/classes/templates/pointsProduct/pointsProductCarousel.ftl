...
<div class="modal-header">
    ...
    <h4 class="modal-title">积分商品轮播图</h4>
</div>
<div class="modal-body">
    <form action="#" id="carousel_form" class="form-horizontal" novalidate="novalidate">
        <input type="hidden" name="pointsId" value="${(pointsId)!""}">
        <input type="hidden" id="imgSrc" name="imgUrl">
        <#assign index = 0 >
        <div class="form-body">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn green circle" onclick="Duang.getService('pointsProductService').pointsProductCarouselSave()"><i class="fa fa-save"></i> 保存或更新 </button>
    <button type="button" class="btn green circle" onclick="Duang.getService('pointsProductService').pointsProductCarouselDelete()"><i class="fa fa-save"></i> 删除 </button>
</div>