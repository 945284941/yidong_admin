...
<div class="modal-footer">
    ...
    <button type="button" class="btn green circle" onclick="Duang.getService('productService').productCarouselSave()"><i class="fa fa-save"></i> 保存或更新 </button>
    <button type="button" class="btn green circle" onclick="Duang.getService('productService').productCarouselDelete()"><i class="fa fa-save"></i> 删除 </button>
</div>