                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon right" id="yuaneyePass">
                                <i class="fa fa-eye" id="yuaneye" state="yes" ></i>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon right" id="eyePass">
                                <i class="fa fa-eye" id="eye" state="yes" ></i>
                                <input type="password" id="newPassword" name="newPassword" class="form-control" data-required="1" placeholder="">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" >
                            <div class="input-icon right" id="chongeyePass">
                                <i class="fa fa-eye" id="chongeye" state="yes" ></i>
                                <input type="password" name="newPwdagin" data-required="1" class="form-control" >
