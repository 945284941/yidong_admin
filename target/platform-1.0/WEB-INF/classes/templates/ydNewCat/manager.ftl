                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">新闻分类名称:</label>
                                                <div class="col-lg-1">
                    ...
                    <div class="col-md-3">
                        <div class="actions pull-right">
                            <a class="btn btn-circle btn-outline green active"
                               onclick="Duang.getService('ydNewCatService').loadTable();"><i class="icon-magnifier"></i>
                                查询</a>
                            <a class="btn btn-circle btn-outline blue empty"
                               onclick="Duang.getService('ydNewCatService').reset();"><i class="glyphicon glyphicon-refresh"></i>
                                重置</a>
                            <a class="btn btn-circle green"
                               href="javascript:Duang.getService('ydNewCatService').add()" role="button"><i
...
<script type="text/javascript">
    $(function () {
        ...
        document.onkeydown = function (event) {
            ...
            if (e.keyCode == 13) {
                Duang.getService('ydNewCatService').loadTable();
            }
        }
