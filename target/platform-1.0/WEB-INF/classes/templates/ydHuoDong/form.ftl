...
<div class="modal-body">
    <form id="system_expert_form_table" class="form-horizontal"
        ...
        <div class="form-group">
            <label class="control-label col-md-3">活动标题：
        ...
        <div class="form-group">
            <label class="control-label col-md-3">活动类型：
                <span class="required" aria-required="true"> * </span>
            </label>
            <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">活动图片：
                <span class="required" aria-required="true"> * </span>
            </label>
            <div class="col-md-7">
        ...
        <div class="form-group">
            <label class="control-label col-md-3">活动内容：
                <span class="required" aria-required="true"> * </span>
            </label>
            <div class="col-md-7">
