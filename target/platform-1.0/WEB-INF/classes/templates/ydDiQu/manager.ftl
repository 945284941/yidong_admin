                    ...
                    <div class="col-md-3">
                        <div class="actions pull-right">
                            <a class="btn btn-circle btn-outline green active"
                               onclick="Duang.getService('ydDiQuService').loadTable();"><i class="icon-magnifier"></i>
                                查询</a>
                            <a class="btn btn-circle btn-outline blue empty"
                               onclick="Duang.getService('ydDiQuService').reset();"><i class="glyphicon glyphicon-refresh"></i>
                                重置</a>
                            <a class="btn btn-circle green"
                               href="javascript:Duang.getService('ydDiQuService').add()" role="button"><i
...
<script type="text/javascript">
    $(function () {
        ...
        document.onkeydown = function (event) {
            ...
            if (e.keyCode == 13) {
                Duang.getService('ydDiQuService').loadTable();
            }
        }
