                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label class="col-md-6 control-label">时间选择:</label>
                                                <#--<div class="col-md-9">
                                                    <div class="input-group input-large date-picker input-daterange" data-date="2017/01/01" data-date-format="yyyy/mm/dd">
                                                        <input onclick="laydate()" type="text" class="form-control" readonly name="startTime">
                                                        <span class="input-group-addon"> to </span>
                                                        <input onclick="laydate()" type="text" class="form-control" readonly name="endTime">
                                                    </div>
                                                </div>-->
                                                <div class="col-md-2">

                                                    <div class="input-group input-large">
                                                        <input type="text" onclick="$(this).calendar()" class="form-control "
