                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">调查问题:</label>
                                                <div class="col-lg-1">
                                                    <div class="input-group " style="width:200px;">
                                                        <input type="text" id="system_expert_manager_search_name" name="question" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" value="${id}" name="questionnaireId">
                    ...
                    <div class="col-md-3">
                        <div class="actions pull-right">
                            <a class="btn btn-circle btn-outline green active"
                               onclick="Duang.getService('ydQuestionnaireService').messageloadTable('${id}');"><i class="icon-magnifier"></i>
                                查询</a>
                            <a class="btn btn-circle btn-outline blue empty"
                               onclick="Duang.getService('ydQuestionnaireService').messagereset('${id}');"><i class="glyphicon glyphicon-refresh"></i>
                                重置</a>
                            <a class="btn btn-circle green"
                               href="javascript:Duang.getService('ydQuestionnaireService').messageadd('${id}')" role="button"><i
...
<script type="text/javascript">
    $(function () {
        ...
        document.onkeydown = function (event) {
            ...
            if (e.keyCode == 13) {
                Duang.getService('ydQuestionnaireService').loadTable();
            }
        }
        ...
        Duang.getService('ydQuestionnaireService').messageloadTable('${id}');
