                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label">律师姓名:</label>
                                                <div class="col-lg-1">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-1">
                                                    <div class="input-group " style="width:200px;">
                                                        <input type="text" id="system_expert_manager_search_name"
                    ...
                    <div class="col-md-3">
                        <div class="actions pull-right">
                            <a class="btn btn-circle btn-outline green active"
                               onclick="Duang.getService('lawyerService').loadTable();"><i class="icon-magnifier"></i>
                                查询</a>
                            <a class="btn btn-circle btn-outline blue empty"
                               onclick="Duang.getService('lawyerService').reset();"><i class="glyphicon glyphicon-refresh"></i>
                                重置</a>
                            <a class="btn btn-circle green"
                               href="javascript:Duang.getService('lawyerService').add()" role="button"><i
...
<script type="text/javascript">
    $(function () {
        ...
        document.onkeydown = function (event) {
            ...
            if (e.keyCode == 13) {
                Duang.getService('lawyerService').loadTable();
            }
        }
