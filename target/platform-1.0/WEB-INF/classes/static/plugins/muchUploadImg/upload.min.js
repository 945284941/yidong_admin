        ...
        $.ajax({
            ...
            success: function (m) {
                ...
                if (m.success == true) {
                    ...
                    $('#baby').append("<img src = "+m.message+"   onclick='fangda(\""+m.message+"\")' ondblclick='deleyebyPic(this,\""+m.message+"\")'   style='width:100px;height:100px;margin-right:10px;margin-top:10px;'>")
                    var  muchPic = $('#muchPic').val();


                     if(muchPic == null || typeof(muchPic) == undefined || muchPic == '' ){

                         muchPic = m.message;
                     }else{
                         console.log(1 +"---"+muchPic)
