var lawyerService = new Class({
    Extends: project.Service,
    options: {
        serviceName: 'lawyerService',
    ...
    loadTable: function () {
        ...
        $.get(project.path + '/lawyer/table',param,function(data){
    ...
    reset:function(){
        ...
        $.get(project.path + '/lawyer/table',function(data){
            $('#'+_this.options.contentName).html(data);
        })
    },
    edit: function (id) {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/lawyer/edit?id=" + id
        });
    },
    add: function () {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/lawyer/insert"
        });
    },
    delete: function (id) {
        ...
        if (r) {
            var $this = this;
            $.post(project.path + '/lawyer/delete?id=' + id, function (data) {
                if (data.success) {
                    $this.loadTable();
    ...
    saveOrUpdate: function () {
        ...
        var param = $('#' + this.options.formName).formToJson();
                ...
                $.post(project.path + '/lawyer/save', param, function (data) {
                    if (data.success) {
