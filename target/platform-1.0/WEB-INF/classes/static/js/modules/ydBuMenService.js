var ydBuMenService = new Class({
    Extends: project.Service,
    options: {
        serviceName: 'ydBuMenService',
    ...
    loadTable: function () {
        ...
        $.get(project.path + '/ydBuMen/table',param,function(data){
    ...
    reset:function(){
        ...
        $.get(project.path + '/ydBuMen/table',function(data){
            $('#'+_this.options.contentName).html(data);
        })
    },
    edit: function (id) {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/ydBuMen/edit?id=" + id
        });
    },
    add: function () {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/ydBuMen/insert"
        });
    },
    delete: function (id) {
        ...
        if (r) {
            var $this = this;
            $.post(project.path + '/ydBuMen/delete?id=' + id, function (data) {
                if (data.success) {
                    $this.loadTable();
    ...
    saveOrUpdate: function () {
        ...
        var param = $('#' + this.options.formName).formToJson();
                ...
                $.post(project.path + '/ydBuMen/save', param, function (data) {
                    if (data.success) {
