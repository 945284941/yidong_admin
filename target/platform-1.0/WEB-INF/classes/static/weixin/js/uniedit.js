...
$(function () {
 $(window).resize(function(){
		...
		$('#editor,.edui-editor-iframeholder').height(win_height+210);
		$('#styleselect').height(win_height+210);
		$('.content').height(win_height+110);
	}).trigger('resize');
