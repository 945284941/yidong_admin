...
<div class="modal-header">
    ...
    <h4 class="modal-title">新闻分类设置       </h4>
</div>
<div class="modal-body">
    <form id="system_expert_form_table" class="form-horizontal"
        ...
        <div class="form-group">
            <label class="control-label col-md-3">新闻分类名称：
...
<div style="text-align: center;margin-bottom: 10px;">
    ...
    <button type="button" onclick="Duang.getService('ydNewCatService').saveOrUpdate()" class="btn green circle"><i
