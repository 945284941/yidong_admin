var bannerService = new Class({
    ...
    loadTable: function () {
        ...
        $.get(project.path + '/banner/table',param,function(data){
    ...
    reset:function(){
        ...
        $.get(project.path + '/banner/table',function(data){
            $('#'+_this.options.contentName).html(data);
        })
    },
    edit: function (id) {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/banner/edit?id=" + id
        });
    },
    add: function () {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/banner/insert"
        });
    },
    delete: function (id) {
        ...
        if (r) {
            var $this = this;
            $.post(project.path + '/banner/delete?id=' + id, function (data) {
                if (data.success) {
                    $this.loadTable();
    ...
    saveOrUpdate: function () {
        ...
        var param = $('#' + this.options.formName).formToJson();
                ...
                $.post(project.path + '/banner/save', param, function (data) {
                    if (data.success) {
