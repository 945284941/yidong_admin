var ydYuanGongService = new Class({
    Extends: project.Service,
    options: {
        serviceName: 'ydYuanGongService',
    ...
    loadTable: function () {
        ...
        $.get(project.path + '/ydYuanGong/table',param,function(data){
    ...
    reset:function(){
        ...
        $.get(project.path + '/ydYuanGong/table',function(data){
            $('#'+_this.options.contentName).html(data);
        })
    },
    edit: function (id) {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/ydYuanGong/edit?id=" + id
        });
    },
    add: function () {
        $("#" + this.options.modalName).modal({
    ...
    delete: function (id) {
        ...
        if (r) {
            var $this = this;
            $.post(project.path + '/ydYuanGong/delete?id=' + id, function (data) {
                if (data.success) {
                    $this.loadTable();
    ...
    saveOrUpdate: function () {
        ...
        var param = $('#' + this.options.formName).formToJson();
                ...
                $.post(project.path + '/ydYuanGong/save', param, function (data) {
                    if (data.success) {
