var ydZhiWeiService = new Class({
    Extends: project.Service,
    options: {
        serviceName: 'ydZhiWeiService',
    ...
    loadTable: function () {
        ...
        $.get(project.path + '/ydZhiWei/table',param,function(data){
    ...
    reset:function(){
        ...
        $.get(project.path + '/ydZhiWei/table',function(data){
            $('#'+_this.options.contentName).html(data);
        })
    },
    edit: function (id) {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/ydZhiWei/edit?id=" + id
        });
    },
    add: function () {
        $("#" + this.options.modalName).modal({
            remote: project.path + "/ydZhiWei/insert"
        });
    },
    delete: function (id) {
        ...
        if (r) {
            var $this = this;
            $.post(project.path + '/ydZhiWei/delete?id=' + id, function (data) {
                if (data.success) {
                    $this.loadTable();
    ...
    saveOrUpdate: function () {
        ...
        var param = $('#' + this.options.formName).formToJson();
                ...
                $.post(project.path + '/ydZhiWei/save', param, function (data) {
                    if (data.success) {
