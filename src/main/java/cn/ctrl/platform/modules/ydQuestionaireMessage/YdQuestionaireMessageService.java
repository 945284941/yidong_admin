package cn.ctrl.platform.modules.ydQuestionaireMessage;
...
@Slf4j
public class YdQuestionaireMessageService extends BaseService {


    @Autowired
    YdQuestionnaireMessageMapper rechargeMapper;
    ...
    public PageInfo findAll(Map map, Integer pageNo, Integer pageSize) {
        ...
        List<YdQuestionnaireMessage> goodsList = rechargeMapper.findAll(map);

        return new PageInfo(goodsList);
    }


    public YdQuestionnaireMessage  selectOne(String id) {

        YdQuestionnaireMessage goods = rechargeMapper.selectByPrimaryKeyy(id);
    ...
    public int addGoods(YdQuestionnaireMessage equipment, Map<String, Object> map) {
...
//             }
    ...
    public List<YdQuestionnaireMessage> findAllNoPage(){
