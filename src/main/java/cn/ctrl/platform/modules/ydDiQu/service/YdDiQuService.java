package cn.ctrl.platform.modules.ydDiQu.service;
...
@Slf4j
public class YdDiQuService extends BaseService {

    @Autowired
    YdDiquMapper rechargeMapper;
    ...
    public PageInfo findAll(Map map, Integer pageNo, Integer pageSize) {
        ...
        List<YdDiqu> goodsList = rechargeMapper.findAll(map);

        return new PageInfo(goodsList);
    }


    public YdDiqu  selectOne(String id) {

        YdDiqu goods = rechargeMapper.selectByPrimaryKeyy(id);
    ...
    public int addGoods(YdDiqu equipment, Map<String, Object> map) {
...
//             equipment.setCreateBy(this.getCurrentSysUser().getId());
    ...
    public List<YdDiqu> findAllNoPage(){
