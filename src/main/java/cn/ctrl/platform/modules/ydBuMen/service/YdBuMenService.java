package cn.ctrl.platform.modules.ydBuMen.service;
...
@Slf4j
public class YdBuMenService extends BaseService {

    @Autowired
    YdBumenMapper rechargeMapper;
    ...
    public PageInfo findAll(Map map, Integer pageNo, Integer pageSize) {
        ...
        List<YdBumen> goodsList = rechargeMapper.findAll(map);

        return new PageInfo(goodsList);
    }


    public YdBumen  selectOne(String id) {

        YdBumen goods = rechargeMapper.selectByPrimaryKeyy(id);
    ...
    public int addGoods(YdBumen equipment, Map<String, Object> map) {
...
//             equipment.setCreateBy(this.getCurrentSysUser().getId());
    ...
    public List<YdBumen> findAllNoPage(Map map){
